...
public class HMacMD5Util {
    ...
    public static String getHmacMd5Bytes(String key, String data) {
        try {
            return HMacMD5Util.bytesToHexString(getHmacMd5Bytes(key.getBytes(),data.getBytes()));
        }catch (Exception e){
            e.printStackTrace();
        }
        return "";
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        String aa = "appId=66491&bizData={\"opList\":[{\"cellNo\":\"1\",\"ops\":[\"DOOR_OPEN\"]}],\"deviceId\":\"TestAndroid_3\"}&method=device.cells.ops&timestamp=2019-12-17 21:00:00&version=1.0";
        System.out.println(getHmacMd5Bytes("682dd101cc64b05d0acb43ad96834ae3",aa));
    }
}
