 ...
 * @since 1.0
 */
public class LinkOpenCellsResponse extends LinkResponse {

    @JsonProperty("Data")
    private LinkOpenCellsResponse.Data data;

    public LinkOpenCellsResponse() {
    }

    public LinkOpenCellsResponse.Data getData() {
        return this.data;
    }

    public void setData(LinkOpenCellsResponse.Data data) {
        this.data = data;
    }
