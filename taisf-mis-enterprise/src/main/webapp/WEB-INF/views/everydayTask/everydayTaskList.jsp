        ...
        <div class="ibox-content">
            <div class="row" style="margin-top: 10px;">
                <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <button class="btn btn-primary" type="button" onclick="everydayTaskListExcel();">
...
<script>
    ...
    function everydayTaskListExcel(){
        window.location.href="everydayTask/everydayTaskListExcel?enterpriseCode=" + $("#enterpriseCodeS").val();
    }
</script>
</body>
</html>
